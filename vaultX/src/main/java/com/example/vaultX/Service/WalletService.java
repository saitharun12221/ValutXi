...
public class WalletService{
    ...
    public Map<String,Object> getWalletwithAllCurrencies(int wallet_id,CurrencyType[] targetCurrencies){
        ...
        result.put("Get balances with All Currencies",exchangeRateService.getWalletBalanceinMultiplieCurrencies(wallet_id,targetCurrencies));
        return result;
    }
    ...
    public Wallet Withdrawal(Integer walletId, BigDecimal amount) {
        if (amount.compareTo(BigDecimal.ZERO) <= 0) {
